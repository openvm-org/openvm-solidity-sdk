...
```solidity
import { IOpenVmHalo2Verifier } from "openvm-solidity-sdk/v2.0/interfaces/IOpenVmHalo2Verifier.sol";
...
```bash
forge create src/v2.0/OpenVmHalo2Verifier.sol:OpenVmHalo2Verifier --rpc-url $RPC --private-key $PRIVATE_KEY --broadcast
```
