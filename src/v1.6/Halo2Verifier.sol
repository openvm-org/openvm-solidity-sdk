    ...
    fallback(bytes calldata) external returns (bytes memory) {
        assembly ("memory-safe") {
            ...
            mstore(
                0x1240,
                addmod(
                    mload(0x1220), 21888242871839275222246405745257275088548364400416034343698204186575808495616, f_q
                )
            )
            mstore(
                0x1260,
                mulmod(
                    mload(0x1240), 21888241567198334088790460357988866238279339518792980768180410072331574733841, f_q
                )
            )
            mstore(
                0x1280,
                mulmod(
                    mload(0x1260), 12929131318670223636853686797196826072950305380535537217467769528748593133487, f_q
                )
            )
            mstore(
                0x12a0,
            ...
            mstore(
                0x12c0,
                mulmod(
                    mload(0x1260), 14655294445420895451632927078981340937842238432098198055057679026789553137428, f_q
                )
            )
            mstore(
                0x12e0,
            ...
            mstore(
                0x1300,
                mulmod(
                    mload(0x1260), 12220484078924208264862893648548198807365556694478604924193442790112568454894, f_q
                )
            )
            mstore(
                0x1320,
            ...
            mstore(
                0x1400,
                mulmod(
                    mload(0x1260), 17329448237240114492580865744088056414251735686965494637158808787419781175510, f_q
                )
            )
            mstore(
                0x1420,
            ...
            mstore(
                0x1480,
                mulmod(
                    mload(0x1260), 11451405578697956743456240853980216273390554734748796433026540431386972584651, f_q
                )
            )
            mstore(
                0x14a0,
            ...
            mstore(
                0x1500,
                mulmod(
                    mload(0x1260), 21490807004895109926141140246143262403290679459142140821740925192625185504522, f_q
                )
            )
            mstore(
                0x1520,
            ...
            mstore(
                0x1540,
                mulmod(
                    mload(0x1260), 11211301017135681023579411905410872569206244553457844956874280139879520583390, f_q
                )
            )
            mstore(
                0x1560,
            ...
            mstore(
                0x1580,
                mulmod(
                    mload(0x1260), 18846108080730935585192484934247867403156699586319724728525857970312957475341, f_q
                )
            )
            mstore(
                0x15a0,
            ...
            mstore(
                0x1600,
                mulmod(
                    mload(0x1260), 21451937155080765789602997556105366785934335730087568134349216848800867145453, f_q
                )
            )
            mstore(
                0x1620,
            ...
            mstore(
                0x1680,
                mulmod(
                    mload(0x1260), 13982290267294411190096162596630216412723378687553046594730793425118513274800, f_q
                )
            )
            mstore(
                0x16a0,
            ...
            mstore(
                0x1740,
                mulmod(
                    mload(0x1260), 12619617507853212586156872920672483948819476989779550311307282715684870266992, f_q
                )
            )
            mstore(
                0x1760,
            ...
            mstore(
                0x17c0,
                mulmod(
                    mload(0x1260), 18610195890048912503953886742825279624920778288956610528523679659246523534888, f_q
                )
            )
            mstore(
                0x17e0,
            ...
            mstore(
                0x1840,
                mulmod(
                    mload(0x1260), 19032961837237948602743626455740240236231119053033140765040043513661803148152, f_q
                )
            )
            mstore(
                0x1860,
            ...
            mstore(
                0x18c0,
                mulmod(
                    mload(0x1260), 14875928112196239563830800280253496262679717528621719058794366823499719730250, f_q
                )
            )
            mstore(
                0x18e0,
            ...
            mstore(
                0x1980,
                mulmod(
                    mload(0x1260), 14391499717548074167711220639833994904150450341569029103202493919171555826079, f_q
                )
            )
            mstore(
                0x19a0,
            ...
            mstore(
                0x1a00,
                mulmod(
                    mload(0x1260), 10119780362642123194334092174270235809557798114544683654677907882314807212354, f_q
                )
            )
            mstore(
                0x1a20,
            ...
            mstore(
                0x1b00,
                mulmod(
                    mload(0x1260), 11145214675344139457514777444556774698911688619991656085001542609383151586084, f_q
                )
            )
            mstore(
                0x1b20,
            ...
            mstore(
                0x1b80,
                mulmod(
                    mload(0x1260), 19228510170961893342195489288913594506775385223367826565223897736323409650249, f_q
                )
            )
            mstore(
                0x1ba0,
            ...
            mstore(
                0x1c00,
                mulmod(
                    mload(0x1260), 10094752117139066216691253588991632982053223883646966177987813353508871280747, f_q
                )
            )
            mstore(
                0x1c20,
            ...
            mstore(
                0x1c80,
                mulmod(
                    mload(0x1260), 21346203717540287263608402129024479709126363130664317843105498655869866203005, f_q
                )
            )
            mstore(
                0x1ca0,
            ...
            mstore(
                0x1d00,
                mulmod(
                    mload(0x1260), 13788243025932779125104144225768424453664118806559109014238064020826883170336, f_q
                )
            )
            mstore(
                0x1d20,
            ...
            mstore(
                0x1e40,
                mulmod(
                    mload(0x1260), 14557038802599140430182096396825290815503940951075961210638273254419942783582, f_q
                )
            )
            mstore(
                0x1e60,
            ...
            mstore(
                0x1e80,
                mulmod(
                    mload(0x1260), 21631349642691366221117117325940229443266870213711402446456178962469345982255, f_q
                )
            )
            mstore(
                0x1ea0,
            ...
            mstore(
                0x1ec0,
                mulmod(
                    mload(0x1260), 16976236069879939850923145256911338076234942200101755618884183331004076579046, f_q
                )
            )
            mstore(
                0x1ee0,
            ...
            mstore(
                0x1f00,
                mulmod(
                    mload(0x1260), 18106030913818996184930975996483865250387924434749113154514488995517615180373, f_q
                )
            )
            mstore(
                0x1f20,
            ...
            mstore(
                0x1f40,
                mulmod(
                    mload(0x1260), 13553911191894110065493137367144919847521088405945523452288398666974237857208, f_q
                )
            )
            mstore(
                0x1f60,
            ...
            mstore(
                0x1f80,
                mulmod(
                    mload(0x1260), 15126807493918544618788554261654793824894621953586710625413511093368555507114, f_q
                )
            )
            mstore(
                0x1fa0,
            ...
            mstore(
                0x3b20,
                mulmod(
                    mload(0x3b00), 11451405578697956743456240853980216273390554734748796433026540431386972584651, f_q
                )
            )
            {
            ...
            mstore(
                0x3bc0,
                mulmod(
                    21558793644302942916864965630979640748886316167261336210841195936026980690666, mload(0x3920), f_q
                )
            )
            mstore(
                0x3be0,
                mulmod(
                    mload(0x3bc0), 21490807004895109926141140246143262403290679459142140821740925192625185504522, f_q
                )
            )
            {
            ...
            mstore(
                0x3d20,
                mulmod(
                    mload(0x3d00), 11451405578697956743456240853980216273390554734748796433026540431386972584651, f_q
                )
            )
            {
            ...
            mstore(
                0x3de0,
                mulmod(
                    mload(0x3dc0), 17329448237240114492580865744088056414251735686965494637158808787419781175510, f_q
                )
            )
            {
